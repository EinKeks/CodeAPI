...
--
-- Host: localhost:3306
-- Generation Time: Apr 21, 2017 at 03:16 AM
...
--
-- Table structure for table `c_i`
--

CREATE TABLE IF NOT EXISTS `c_i` (
...
--
-- Table structure for table `nm_user_ci`
--

CREATE TABLE IF NOT EXISTS `nm_user_ci` (
  `userID` int(11) NOT NULL,
  `ciID` int(11) NOT NULL,
  PRIMARY KEY (`userID`,`ciID`),
  KEY `nm_user_ci` (`ciID`)
